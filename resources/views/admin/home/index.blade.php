        ...
        <section class="metrics-grid">
            ...
            <div class="metric-card">
                ...
                <div class="metric-info">
                    <span class="metric-title">Tổng chương trình đang diễn ra</span>
            ...
            @forelse ($programs as $index => $prog)
                <div class="program-row">
                    ...
                    <div class="program-row-actions">
                        <a href="{{ route('frontend.chuong-trinh.show', ['id' => $prog->Id]) }}" target="_blank" class="link-details">Xem chi tiết</a>
                    </div>
                </div>
            @empty
